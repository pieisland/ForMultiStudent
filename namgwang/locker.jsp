...
-->
	...
	<%
		String lockerday = (String)request.getAttribute("lockerday");	
		lockerday = lockerday.replaceAll("\n", "<br/>");	
		//이건 안됨요.
		//int lockok = (int)request.getAttribute("lockerApplyPos");
	%>
						...
						<div class="myrow" style="margin:10px 0;">
							<div class="mycol-md-11 mycol-md-offset-1">
								<div style="margin:0 auto">
									<button style="color:white" class="updateLockerDayBtn" onclick="updateLockerDay()">수정하기</button>
								</div>
							</div>
						</div>
					</c:if>
				                ...
				                <div class="mycol-xs-12">
				                  ...
				                  <div class="myrow"><!--두번쨰 줄이에요. -->
				                    <div style="margin:0 auto; width:260px"><!-- 중간에 두려고 이거 놔둔거에용.-->
				                      ...
				                      <div class="locker" style="width:44px; height:60px; display:inline-block; background-color: #8FC8ED;"><p>실습실</p></div>
		...
		<!-- Scripts -->
		    ...
		    <script>
		      ...
		      function init(){
		        ...
		        if(isSelpos == 0){ //어차피 신청을 했어야 이 값이 0이 되는 거라 위의 if에 영향 없음.
